...
export function buildStructureLock(hkAnchorsLite) {
  ...
  if (lensRisk !== 'wide_risk') {
    extra.push('No wide-angle/fisheye/vignette. Keep straight lines. Same camera position and field of view as the input photo.');
  } else {
    extra.push('Avoid wide-angle look; keep vertical lines straight. Same camera position and field of view as the input photo.');
  }
  ...
  return [
    ...
    'Keep window and door positions EXACTLY the same. Do not add new windows/doors.',
